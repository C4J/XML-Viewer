...
public class JLicenseInfo implements Comparable<JLicenseInfo>
{
	...
	{
		return util.padString(description, true, width_description, " ") +util.padString(version, true, width_version, " ")+type;
	...
	public LinkedList<JLicenseInfo> getLicences()
	{
		...
		JLicenseInfo test = new JLicenseInfo("XML Viewer","GNU General Public License V2.txt",ViewTree.version,"GNU General Public License V2");
